...
{
    public function __construct($err_msg, $errorCode, $err_severity, $err_file, $err_line)
    {

        parent::__construct("$err_msg in $err_file at $err_line line.", $errorCode);
    }
    ...
    static function initErrorHandler()
    {
        set_error_handler(function ($err_severity, $err_msg, $err_file, $err_line, array $err_context) {
            ...
            switch ($err_severity) {
                ...
                default:
                    throw new self($err_msg, 0, $err_severity, $err_file, $err_line);
            }
        });
    }
}
